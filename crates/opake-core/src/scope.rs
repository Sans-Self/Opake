...
pub const OPAKE_COLLECTIONS: &[&str] = &[
    ...
    crate::records::DIRECTORY_UPDATE_COLLECTION,
    crate::documents::DOCUMENT_COLLECTION,
    crate::records::DOCUMENT_UPDATE_COLLECTION,
    crate::sharing::GRANT_COLLECTION,
    crate::records::INVITATION_COLLECTION,
    crate::records::INVITATION_ACCEPTANCE_COLLECTION,
    crate::keyrings::KEYRING_COLLECTION,
    crate::records::KEYRING_UPDATE_COLLECTION,
