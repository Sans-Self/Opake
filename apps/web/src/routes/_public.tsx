...
const NAV_LINKS: readonly NavItem[] = [
  ...
  { label: "Source code", href: "https://github.com/Opake-at/Opake" },
];
...
const FOOTER_GROUPS: readonly FooterGroup[] = [
  ...
  },
  {
    ...
    links: [
      { label: "Source Code", href: "https://github.com/Opake-at/Opake" },
      { label: "Report Issues", href: "https://github.com/Opake-at/Opake/issues" },
      {
        label: "Contributing",
        href: "https://github.com/Opake-at/Opake/blob/main/CONTRIBUTING.md",
      },
    ],
  },
];
