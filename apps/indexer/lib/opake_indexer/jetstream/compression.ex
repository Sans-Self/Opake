defmodule OpakeIndexer.Jetstream.Compression do
  @moduledoc """
  ...
  @dict_path Application.app_dir(:opake_indexer, "priv/jetstream_zstd_dict")
  ...
  Called from `OpakeIndexer.Application.start/2` so the ddict is ready
