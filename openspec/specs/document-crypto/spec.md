...
- Which URI (genesis vs head) a wrap or an indexer call must use, and the identity invariant behind `Keyring::lineage_anchor` — the workspace-identity spec.
